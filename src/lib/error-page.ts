...
<html lang="ar" dir="rtl">
  <head>
    ...
    <style>
      body { font: 15px/1.7 "Tajawal","Cairo",system-ui,-apple-system,sans-serif; background: #050507; color: #F8FAFC; display: grid; place-items: center; min-height: 100vh; margin: 0; padding: 1.5rem; text-align: center; }
