...
const PRICING_MONTHLY = [
  ...
  },
  {
    ...
    cycle: "/شهرياً",
    highlighted: true,
    features: ["حتى 8 قنوات بث", "مكتبة غير محدودة", "حتى 200 مشاهد", "تخصيص كامل (White-label)", "دعم أولوية"],
  },
  {
    name: "Enterprise",
    price: "$199",
...
const PRICING_LIFETIME = [
  { name: "Basic — مدى الحياة", price: "$299", cycle: "دفعة واحدة", features: ["نفس مزايا Basic", "تحديثات سنة كاملة", "بدون اشتراك شهري"] },
  { name: "Pro — مدى الحياة", price: "$799", cycle: "دفعة واحدة", highlighted: true, features: ["نفس مزايا Pro", "تحديثات سنتين", "أولوية الميزات الجديدة"] },
  { name: "Enterprise — مدى الحياة", price: "$1,999", cycle: "دفعة واحدة", features: ["نفس مزايا Enterprise", "تحديثات مدى الحياة", "تركيب وتدريب مجاني"] },
];
