...
- Commercial readiness docs now exist for sales gating, Arabic customer installation, Arabic admin operations, network requirements, and release validation.
- Public viewer copy guard is part of `npm test` and fails if subscriber-facing text leaks admin/server/provider/streaming internals.
